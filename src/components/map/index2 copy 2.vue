<template>
	<div class="wrap" style="height: 100%; width: 100%">
		<l-map v-if="showMap" :zoom="zoom" :center="center" :maxBounds="[]" :options="mapOptions"
			@update:center="centerUpdate" ref="myMap" @ready="doSomethingOnReady()" @update:zoom="zoomUpdate">
	...
	export default {
		...
		data() {
			return {
				// bounds: [[-10, 180], [-1, -480]],
				zoom: 2,
				center: latLng(-10, 110),
				// url: 'https://webst01.is.autonavi.com/appmaptile?style=6&x={x}&y={y}&z={z}',
				// url:'http://222.128.56.122:8185/fmserver/service/plow_land_2001_2003_wd/wmts',
